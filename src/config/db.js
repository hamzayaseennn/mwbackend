...
const connectDB = async () => {
  try {
    ...
    if (isAtlas) {
      ...
      console.error('   → Click "Allow Access from Anywhere" (or enter 0.0.0.0/0 for all IPs)');
      console.error('   → Click "Confirm"');
      console.error('\n2. ✅ Verify Connection String:');
      console.error('   → Check your environment variables have: MONGODB_URI=mongodb+srv://...');
      ...
      console.error('   → You should whitelist 0.0.0.0/0 (all IPs)');
      console.error('   → Cloud platforms use dynamic IP addresses');
      console.error('\n═══════════════════════════════════════════════════════\n');
    } else {
      console.error('\n═══════════════════════════════════════════════════════');
